Projeto Criado para a Faculdade Anhebi Morunbi, onde foi pedido um projeto no qual serão inseridos números de forma ordenada, e que atenda as especificações a seguir: 
